...
**MANDATORY: Log file changes IMMEDIATELY after each modification using `mcp_auxly_auxly_log_file_change`**
...
- Modifying files without calling `mcp_auxly_auxly_log_file_change`
...
**ENFORCEMENT: Call `mcp_auxly_auxly_log_file_change` IMMEDIATELY after each file operation. NO batch logging.**
